...
const JavaScriptIcon = () => {
    return (
        <svg style={{borderRadius: "20px"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><title>file_type_js_official</title>
            <rect x="0" y="0" width="40" height="40" fill={"#f5de19"}  />
